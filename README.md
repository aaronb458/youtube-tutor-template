...
Copy this whole message. Replace `PASTE-YOUTUBE-URL-HERE` with the YouTube channel URL you want to turn into a tutor (like `https://www.youtube.com/@MrBeast`). Then paste it into Claude Code and press Enter:
