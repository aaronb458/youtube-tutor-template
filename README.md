...
**(IF CLAUDE SHOWS [PASTED 10 LINES] etc, go to [[docs.new](url)](https://docs.new/) which opens a new google doc, paste the prompt then replace the PASTE-YOUTUBE-URL-HERE with the actual url)**
